...
//           {/* Editor and buttons inside */}
//           <div>
//             <div
//               ref={editorRef}
//               contentEditable
//               className="min-h-[100px] text-sm focus:outline-none"
//               suppressContentEditableWarning
//             ></div>

//             {/* Action buttons inside editor box */}
//             <div className="flex justify-end gap-2  bg-gray-50">
...
//                style={{ background: "#BBF7D0", border: "none" }}
//                 icon={<SaveOutlined />}
//                 className="bg-green-60 mx-1 text-green-900 "
//                 onClick={handleSave}
//               >
//                 Save
//               </Button>
