...
// const LOCAL_STORAGE_KEY = "user_story_tags";
...
//   const [showColors, setShowColors] = useState(false);
//   const [customColor, setCustomColor] = useState("");
//   const [inputVisible, setInputVisible] = useState(false); // controls if input shows
...
//       const newTags = [...tags, { label, color: finalColor }];
//       setTags(newTags);
...
//             color={tag.color}
//             closable
//             onClose={() => handleRemove(tag.label)}
//             closeIcon={<CloseOutlined />}
//             className="text-white font-normal"
//           >
//             {tag.label}
